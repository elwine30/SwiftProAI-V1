...
using ThinknInsurTech.MultiTenancy.HostDashboard;
...
namespace ThinknInsurTech.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ThinknInsurTechDbContext context, SubscriptionPayment subscriptionPayment)
        {
