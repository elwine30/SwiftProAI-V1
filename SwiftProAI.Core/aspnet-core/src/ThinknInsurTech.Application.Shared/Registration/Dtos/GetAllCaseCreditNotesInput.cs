...
{
    public class GetAllCaseCreditNotesInput : PagedAndSortedResultRequestDto
    {
        ...
        public decimal? MaxMiscSSTFilter { get; set; }
        public decimal? MinMiscSSTFilter { get; set; }
        ...
        public int? IncludeSSTFilter { get; set; }
