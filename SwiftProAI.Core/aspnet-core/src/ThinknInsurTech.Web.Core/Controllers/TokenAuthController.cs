...
using ThinknInsurTech.Authentication.TwoFactor.Google;
...
namespace ThinknInsurTech.Web.Controllers
{
    ...
    public class TokenAuthController : ThinknInsurTechControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(ThinknInsurTechConsts.DateTimeOffsetFormat));
