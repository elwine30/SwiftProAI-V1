...
using ThinknInsurTech.Authentication.TwoFactor;
...
using ThinknInsurTech.Web.Authentication.JwtBearer;
using ThinknInsurTech.Web.Authentication.TwoFactor;
using ThinknInsurTech.Web.Chat.SignalR;
using ThinknInsurTech.Web.Common;
using ThinknInsurTech.Web.Configuration;
using ThinknInsurTech.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using ThinknInsurTech.Authorization.Accounts;

namespace ThinknInsurTech.Web
{
    [DependsOn(
        typeof(ThinknInsurTechApplicationModule),
        typeof(ThinknInsurTechEntityFrameworkCoreModule),
    ...
    public class ThinknInsurTechWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThinknInsurTechWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ThinknInsurTechApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThinknInsurTechWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ThinknInsurTechWebCoreModule).Assembly);
        }
