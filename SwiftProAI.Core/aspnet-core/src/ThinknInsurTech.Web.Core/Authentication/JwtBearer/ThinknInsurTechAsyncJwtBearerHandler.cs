...
{
    public class ThinknInsurTechAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public ThinknInsurTechAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
