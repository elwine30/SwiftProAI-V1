...
/// </summary>
public static class ThinknInsurTechJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, ThinknInsurTechAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
