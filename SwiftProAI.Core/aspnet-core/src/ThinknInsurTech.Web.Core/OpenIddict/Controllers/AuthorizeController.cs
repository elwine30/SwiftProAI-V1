...
using ThinknInsurTech.Web.OpenIddict.Claims;
using ThinknInsurTech.Web.OpenIddict.ViewModels.Authorize;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace ThinknInsurTech.Web.OpenIddict.Controllers
{
