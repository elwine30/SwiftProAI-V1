...
{
    public class UserRepository : ThinknInsurTechRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<ThinknInsurTechDbContext> dbContextProvider)
