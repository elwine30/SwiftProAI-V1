...
using ThinknInsurTech.EntityFrameworkCore.Repositories;

namespace ThinknInsurTech.Organizations
{
    public class UserOrganizationUnitRepository : ThinknInsurTechRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<ThinknInsurTechDbContext> dbContextProvider)
