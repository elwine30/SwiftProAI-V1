...
namespace ThinknInsurTech.OpenIddict.Applications
{
    public class EfCoreOpenIddictApplicationRepository : ThinknInsurTechRepositoryBase<OpenIddictApplication, Guid>,
