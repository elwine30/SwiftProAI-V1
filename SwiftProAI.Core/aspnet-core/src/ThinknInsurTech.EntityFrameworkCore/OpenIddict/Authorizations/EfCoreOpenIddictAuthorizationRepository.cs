...
namespace ThinknInsurTech.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : ThinknInsurTechRepositoryBase<OpenIddictAuthorization, Guid>,
