...
using ThinknInsurTech.Migrations.Seed.Host;
...
namespace ThinknInsurTech.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ThinknInsurTechAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ThinknInsurTechDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ThinknInsurTechConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ThinknInsurTechConsts.ConnectionStringName}", constring);
        }
        ...
        {
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingCompanyRegisterId, input.CompanyRegisterId);
            ...
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingCompanyTelNo, input.CompanyTelNo);
        }
