...
using ThinknInsurTech.MultiTenancy.Payments.Stripe;
using ThinknInsurTech.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace ThinknInsurTech.MultiTenancy.Payments
{
    public class StripePaymentAppService : ThinknInsurTechAppServiceBase, IStripePaymentAppService
    {
                    ...
                    .Select(p => new SessionLineItemOptions
                    {
                        ...
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            ProductData = new SessionLineItemPriceDataProductDataOptions
                            {
                                ...
                                Name = ThinknInsurTechConsts.ProductName
                            }
                        }
                    }).ToList();
            }
