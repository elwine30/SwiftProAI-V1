...
{
    public class SubscriptionAppService : ThinknInsurTechAppServiceBase, ISubscriptionAppService
    {
        ...
        {
            return upgradeAmount < ThinknInsurTechConsts.MinimumUpgradePaymentAmount;
        }
