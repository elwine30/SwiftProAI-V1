...
namespace ThinknInsurTech.Configuration.Host
{
    ...
    public class HostSettingsAppService : SettingsAppServiceBase, IHostSettingsAppService
    {
        ...
        private async Task<HostBillingSettingsEditDto> GetBillingSettingsAsync()
        {
            ...
            {
                CompanyRegisterId = await SettingManager.GetSettingValueAsync(AppSettings.HostManagement.BillingCompanyRegisterId),
                ...
                CompanyTelNo = await SettingManager.GetSettingValueAsync(AppSettings.HostManagement.BillingCompanyTelNo)
            };
        }
