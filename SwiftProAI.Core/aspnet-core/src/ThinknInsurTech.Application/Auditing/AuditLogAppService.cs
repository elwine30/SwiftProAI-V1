...
using ThinknInsurTech.Auditing.Exporting;
using ThinknInsurTech.Authorization;
using ThinknInsurTech.Authorization.Users;
using ThinknInsurTech.Dto;
using ThinknInsurTech.EntityHistory;
using EntityHistoryHelper = ThinknInsurTech.EntityHistory.EntityHistoryHelper;

namespace ThinknInsurTech.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ThinknInsurTechAppServiceBase, IAuditLogAppService
    {
