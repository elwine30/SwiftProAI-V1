...
using ThinknInsurTech.DemoUiComponents.Dto;

namespace ThinknInsurTech.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ThinknInsurTechAppServiceBase, IDemoUiComponentsAppService
    {
