...
using ThinknInsurTech.UiCustomization;
...
{
    public class SessionAppService : ThinknInsurTechAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ThinknInsurTechConsts.Currency,
                        CurrencySign = ThinknInsurTechConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ThinknInsurTechConsts.AllowTenantsToChangeEmailSettings,
                ...
                if (AbpSession.UserId.HasValue)
                {
                    ...
                    output.User.OrganizationUnitId = AbpSession.GetCurrentOUId();
                }
