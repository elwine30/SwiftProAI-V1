...
using ThinknInsurTech.DashboardCustomization.Dto;

namespace ThinknInsurTech.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ThinknInsurTechAppServiceBase, IDashboardCustomizationAppService
    {
