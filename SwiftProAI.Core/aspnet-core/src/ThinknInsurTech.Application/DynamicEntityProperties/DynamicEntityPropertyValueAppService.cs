...
using ThinknInsurTech.DynamicEntityPropertyValues.Dto;

namespace ThinknInsurTech.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : ThinknInsurTechAppServiceBase, IDynamicEntityPropertyValueAppService
    {
