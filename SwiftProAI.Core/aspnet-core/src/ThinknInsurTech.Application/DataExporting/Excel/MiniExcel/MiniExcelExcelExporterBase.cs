...
namespace ThinknInsurTech.DataExporting.Excel.MiniExcel
{
    public abstract class MiniExcelExcelExporterBase : ThinknInsurTechServiceBase, ITransientDependency
    {
