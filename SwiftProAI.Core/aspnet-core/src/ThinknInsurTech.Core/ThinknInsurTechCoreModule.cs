...
using ThinknInsurTech.Authorization.Ldap;
...
using ThinknInsurTech.DashboardCustomization.Definitions;
using ThinknInsurTech.Debugging;
using ThinknInsurTech.DynamicEntityProperties;
using ThinknInsurTech.Features;
using ThinknInsurTech.Friendships;
using ThinknInsurTech.Friendships.Cache;
using ThinknInsurTech.Localization;
using ThinknInsurTech.MultiTenancy;
using ThinknInsurTech.Net.Emailing;
using ThinknInsurTech.Notifications;
using ThinknInsurTech.WebHooks;
...
{
    [DependsOn(
        typeof(ThinknInsurTechCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ThinknInsurTechCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ThinknInsurTechLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ThinknInsurTechConsts.MultiTenancyEnabled;
            ...
            //Replace the service registered for IAbpSession OUAbpSession custom service
            Configuration.ReplaceService<IAbpSession, OUAbpSession>(DependencyLifeStyle.Transient);

            // MailKit configuration
            Configuration.Modules.AbpMailKit().SecureSocketOption = SecureSocketOptions.Auto;
            Configuration.ReplaceService<IMailKitSmtpBuilder, ThinknInsurTechMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ThinknInsurTechSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThinknInsurTechCoreModule).GetAssembly());
        }
