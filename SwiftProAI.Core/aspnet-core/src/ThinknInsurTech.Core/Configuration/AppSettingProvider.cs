...
using ThinknInsurTech.Authentication;
using ThinknInsurTech.DashboardCustomization;
...
namespace ThinknInsurTech.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!ThinknInsurTechConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.TenantManagement.SubscriptionExpireNotifyDayCount,
                    ...
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(AppSettings.HostManagement.BillingCompanyRegisterId,
                    GetFromAppSettings(AppSettings.HostManagement.BillingCompanyRegisterId, "")),
                ...
                new SettingDefinition(AppSettings.HostManagement.BillingCompanyTelNo,
                    GetFromAppSettings(AppSettings.HostManagement.BillingCompanyTelNo, "")),
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.UseCaptchaOnRegistration,
                    ...
                    scopes: SettingScopes.Tenant, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(AppSettings.TenantManagement.BillingCompanyRegisterId, 
                    GetFromAppSettings(AppSettings.TenantManagement.BillingCompanyRegisterId, ""),
                    scopes: SettingScopes.Tenant),
                ...
                new SettingDefinition(AppSettings.TenantManagement.BillingCompanyTelNo,
                    GetFromAppSettings(AppSettings.TenantManagement.BillingCompanyTelNo, ""),
                    scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        ThinknInsurTechConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        ThinknInsurTechDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        ThinknInsurTechDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{ThinknInsurTechDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = ThinknInsurTechDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = ThinknInsurTechDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    ThinknInsurTechDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{ThinknInsurTechDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = ThinknInsurTechDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant
