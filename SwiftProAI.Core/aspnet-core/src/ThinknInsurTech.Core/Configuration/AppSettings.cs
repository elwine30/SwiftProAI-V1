namespace ThinknInsurTech.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        {
            public const string BillingCompanyRegisterId = "App.HostManagement.BillingCompanyRegisterId";
            ...
            public const string BillingCompanyTelNo = "App.HostManagement.BillingCompanyTelNo";
        }
        ...
        public static class TenantManagement
        {
            ...
            public const string BillingCompanyRegisterId = "App.TenantManagement.BillingCompanyRegisterId";
            ...
            public const string BillingCompanyTelNo = "App.TenantManagement.BillingCompanyTelNo";
        }
