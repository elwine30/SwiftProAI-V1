...
namespace ThinknInsurTech.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ThinknInsurTechServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ThinknInsurTech", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
