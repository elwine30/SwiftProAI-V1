...
/// </summary>
public class ThinknInsurTechSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public ThinknInsurTechSimplePermissionDependency()
    {
    ...
    public ThinknInsurTechSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public ThinknInsurTechSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
