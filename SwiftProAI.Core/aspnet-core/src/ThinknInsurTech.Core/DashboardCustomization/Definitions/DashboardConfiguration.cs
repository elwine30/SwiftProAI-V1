...
using ThinknInsurTech.DashboardCustomization.Definitions.Cache;

namespace ThinknInsurTech.DashboardCustomization.Definitions
{
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var dateRangeFilter = new WidgetFilterDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            var simplePermissionDependencyForTenantDashboard =
                new ThinknInsurTechSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);

            var dailySales = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                "WidgetDailySales",
            ...
            var generalStats = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new ThinknInsurTechSimplePermissionDependency(
                    requiresAll: true,
            ...
            var profitShare = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                "WidgetProfitShare",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var memberActivity = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            var regionalStats = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                "WidgetRegionalStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var salesSummary = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                "WidgetSalesSummary",
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            ...
            var topStats = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var simplePermissionDependencyForHostDashboard =
                new ThinknInsurTechSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);

            var incomeStatistics = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            var hostTopStats = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Host.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Host,
                permissionDependency: simplePermissionDependencyForHostDashboard
            );
            ...
            var editionStatistics = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            var subscriptionExpiringTenants = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            var recentTenants = new WidgetDefinition(
                ThinknInsurTechDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                "WidgetRecentTenants",
                side: MultiTenancySides.Host,
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                permissionDependency: simplePermissionDependencyForHostDashboard
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                ThinknInsurTechDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
