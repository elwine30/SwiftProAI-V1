...
{
    public class ThinknInsurTechMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public ThinknInsurTechMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(ThinknInsurTechConsts.LocalizationSourceName, name);
        }
    }
}