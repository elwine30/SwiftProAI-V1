...
namespace ThinknInsurTech.Authorization.Users
{
    ...
    public class User : AbpUser<User>
    {
        ...
        public static User CreateSuperAdminUser(int tenantId, string userName, string emailAddress, string name = null, string surname = null)
        {
            var user = new User
            {
                TenantId = tenantId,
                ...
                Surname = string.IsNullOrWhiteSpace(surname) ? userName : surname,
                EmailAddress = emailAddress,
                Roles = new List<UserRole>(),
                OrganizationUnits = new List<UserOrganizationUnit>()
            };
