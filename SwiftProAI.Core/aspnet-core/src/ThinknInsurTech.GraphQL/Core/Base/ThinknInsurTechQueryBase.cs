...
namespace ThinknInsurTech.Core.Base
{
    public abstract class ThinknInsurTechQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ThinknInsurTechQueryBase(string fieldName,
