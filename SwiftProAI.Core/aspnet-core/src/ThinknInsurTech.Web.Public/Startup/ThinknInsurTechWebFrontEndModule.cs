...
namespace ThinknInsurTech.Web.Public.Startup
{
    [DependsOn(
        typeof(ThinknInsurTechWebCoreModule)
    )]
    public class ThinknInsurTechWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ThinknInsurTechWebFrontEndModule(IWebHostEnvironment env, ThinknInsurTechEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThinknInsurTechWebFrontEndModule).GetAssembly());
        }
    }
}
