...
using ThinknInsurTech.Web.Public.Startup;
using ThinknInsurTech.Web.Session;
using ThinknInsurTech.Web.UiCustomization;

namespace ThinknInsurTech.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ThinknInsurTechViewComponent
    {
