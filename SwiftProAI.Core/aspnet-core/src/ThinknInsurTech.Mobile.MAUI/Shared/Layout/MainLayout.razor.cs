...
using ThinknInsurTech.Services.Navigation;
using Microsoft.AspNetCore.Components;
using ThinknInsurTech.Mobile.MAUI.Services.Account;
using ThinknInsurTech.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using ThinknInsurTech.Mobile.MAUI.Services.Tenants;
using ThinknInsurTech.Mobile.MAUI.Helpers;

#if ANDROID
using ThinknInsurTech.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace ThinknInsurTech.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new ThinknInsurTech.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
