...
using ThinknInsurTech.Identity;
using ThinknInsurTech.Web.Chat.SignalR;
using ThinknInsurTech.Web.Common;
using ThinknInsurTech.Web.Swagger;
using Stripe;
...
using ThinknInsurTech.Schemas;
using ThinknInsurTech.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using ThinknInsurTech.Web.MultiTenancy;
using Abp.HtmlSanitizer;
using Microsoft.AspNetCore.Authentication.Cookies;
using ThinknInsurTech.Web.OpenIddict;
using Microsoft.AspNetCore.Mvc;
using Humanizer;
using static System.Net.WebRequestMethods;

namespace ThinknInsurTech.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Filters.Add(new IgnoreAntiforgeryTokenAttribute()); // support.aspnetzero.com/QA/Questions/10173
            ...
            return services.AddAbp<ThinknInsurTechWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (ThinknInsurTechConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ThinknInsurTech API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("ThinknInsurTech.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "ThinknInsurTech API", Version = "v1"});
                ...
                if (canShowSummaries)
                {
                    ...
                    var applicationXml = $"ThinknInsurTech.Application.xml";
                    var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                    options.IncludeXmlComments(applicationXmlPath);

                    var webCoreXmlFile = $"ThinknInsurTech.Web.Core.xml";
