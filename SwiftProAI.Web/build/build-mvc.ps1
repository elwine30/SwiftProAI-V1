...
$webMvcFolder = Join-Path $slnFolder "src/ThinknInsurTech.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/ThinknInsurTech.Web.Public"
...
dotnet restore ThinknInsurTech.Web.sln
