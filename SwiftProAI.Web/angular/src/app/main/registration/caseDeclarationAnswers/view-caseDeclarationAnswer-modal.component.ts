...
@Component({
    selector: 'viewCaseDeclarationAnswerModal',
    templateUrl: './view-caseDeclarationAnswer-modal.component.html',
})
export class ViewCaseDeclarationAnswerModalComponent extends AppComponentBase {
    ...
    show(registerId?: number): void {
        ...
        this._caseDeclarationAnswersServiceProxy.getCaseDeclarationAnswerForView(registerId).subscribe(result => {
