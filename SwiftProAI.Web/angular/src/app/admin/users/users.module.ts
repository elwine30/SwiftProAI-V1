...
@NgModule({
    declarations: [UsersComponent, EditUserPermissionsModalComponent, CreateOrEditUserModalComponent, ExportExcelUserModalComponent, CreateOrEditStaffModalComponent],
