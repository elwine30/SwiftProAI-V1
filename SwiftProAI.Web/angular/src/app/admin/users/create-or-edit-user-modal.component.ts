...
import { CreateOrEditStaffModalComponent } from '@app/admin/common/staffs/create-or-edit-staff-modal.component';
...
export class CreateOrEditUserModalComponent extends AppComponentBase {
    ...
    userPasswordRepeat = '';
    hasOrganizationUnit: boolean = true;
    ...
    show(userId?: number): void {
        //Check if the user has OU
        this.hasOrganizationUnit = this.currentUser.organizationUnitId != null;
        ...
        this._userService.getUserForEdit(userId).subscribe((userResult) => {
            ...
            this._profileService.getPasswordComplexitySetting().subscribe((passwordComplexityResult) => {
                ...
                this._usersDataService.triggerShow(userId);
                this.modal.show();
            });
        });
    }
    ...
    save(): void {
        ...
        this._userService
            ...
            .subscribe((userId) => {
                ...
                this._usersDataService.triggerSave(userId);
            });
    }
